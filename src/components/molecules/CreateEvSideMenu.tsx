...
const CreateEvSideMenu = ({ open, onClose }: any) => {
  ...
  return (
    <>
      ...
      >
        <Grid container max-width="md" spacing={3}>
          <Typography variant="h3">Crear evento</Typography>

          {/*eventName*/}
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventName">Nombre del evento*</InputLabel>
              <Input
                required
                id="eventName"
                aria-describedby="eventName-helper"
              ></Input>
            </FormControl>
          </Grid>
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationCity">Ciudad*</InputLabel>
              <Input
                required
                id="eventLocationCity"
                aria-describedby="eventLocationCity-helper"
              ></Input>
            </FormControl>
          </Grid>
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationCity">Dirección*</InputLabel>
              <Input
                required
                id="eventLocationAddress"
                aria-describedby="eventLocationAddress-helper"
              ></Input>
            </FormControl>
          </Grid>
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationSpecs">Especificaciones</InputLabel>
              <Input
                required
                id="eventLocationSpecs"
                aria-describedby="eventLocationSpecs-helper"
              ></Input>
              <FormHelperText id="eventLocationSpecs-helper">
                Detalles útiles de la dirección
              </FormHelperText>
            </FormControl>
          </Grid>
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationLatitude">Latitud*</InputLabel>
              <Input
                required
                type="number"  
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationLongitud"> Longitud* </InputLabel>
              <Input
                required
                type="number"  
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationMinAge">Edad minima* </InputLabel>
              <Input
                required
                type="number"  
          ...
          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="eventLocationPrice">Precio* </InputLabel>
              <Input
                required
                type="number"  
          ...
          <Grid item md={12}>
            <FormControl>  
              ...
              ></Input>
              <FormHelperText id="eventUrlPage-helper">
                  Url de los organizadores
              </FormHelperText>
            </FormControl>
          </Grid>
           ...
           <Grid item md={12}>
            ...
            <Autocomplete
              ...
              style={{ width: 300 }}
              renderInput={(params) => <TextField {...params} label="Categorías" variant="standard" />}
            />
            </FormControl>
          </Grid>
          ...
          <Schedule />
          <Typography variant="h6">Fecsdfsdfsdfas</Typography>
          <Typography variant="h6">_____________</Typography>

          <Grid item md={12}>
            <FormControl>
              <InputLabel htmlFor="descriptionEvent">
              ...
              <Input
                ...
                rows={2}
                id="descriptionEvent"
                aria-describedby="descriptionEvent-helper"
              ></Input>
              <FormHelperText id="descriptionEvent-helper">
